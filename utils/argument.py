...
def arg_parse_exp_node_cora():
    parser = argparse.ArgumentParser(description="Arguments for explaining node classification on Cora")

    parser.add_argument('--dataset', type=str, default='Cora', help='Dataset name (default: Cora)')
    parser.add_argument('--gpu', action='store_true', help="Use GPU if available")
    parser.add_argument('--cuda', type=str, default='0', help="CUDA device ID (default: 0)")
    parser.add_argument('--model_path', type=str, default='log/Cora_logs', help="Path to saved model")
    parser.add_argument('--num_epochs', type=int, default=100, help="Number of epochs for explanation (default: 100)")
    parser.add_argument('--lr', type=float, default=0.01, help="Learning rate for the explainer (default: 0.01)")
    parser.add_argument('--weight_decay', type=float, default=5e-4, help="Weight decay (default: 5e-4)")
    parser.add_argument('--lam', type=float, default=1000, help="Lambda regularization parameter (default: 1000)")
    parser.add_argument('--alp', type=float, default=0.6, help="Alpha for explanation loss balancing (default: 0.6)")
    parser.add_argument('--gam', type=float, default=0.5, help="Gamma threshold for explanations (default: 0.5)")
    parser.add_argument('--mask_thresh', type=float, default=0.5, help="Threshold for masking adjacency matrix")
